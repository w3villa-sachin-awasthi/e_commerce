...
function Navbar2() {
    ...
    return (
        <div className="bg-blue-600 w-full my-6 box-border">
            <div className='hidden md:flex items-center  h-[50px] justify-between   w-[100%]  text-white text-[18px] max-w-[1600px]  mx-auto  my-10'>
                <div className='flex  justify-between item center  h-[100%] '>
                    <div className='flex items-center hover:bg-yellow-500 h-[100%] px-8 text-black  relative bg-yellow-500' >
                ...
                <div className='flex item-center  justify-between h-[100%] '>
                    ...
                    <div className='flex items-center h-[100%] hover:bg-yellow-500 px-3  bg-yellow-500 text-black'>
