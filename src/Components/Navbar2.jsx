    ...
    return (
        ...
        <div className='hidden md:flex items-center  h-[50px] justify-between  my-4 w-[100%]  text-white text-[18px] max-w-[1600px]  mx-auto  my-10'>
            <div className='flex  justify-between item center  h-[100%] '>
                <div className='flex items-center hover:bg-yellow-500 h-[100%] px-8 text-black  indicator bg-yellow-500' >
                ...
                <div className='hidden lg:flex items-center  hover:bg-yellow-500 h-[100%] px-3 ml-5' >Multilevel</div>
                <div className='hidden lg:flex items-center hover:bg-yellow-500 h-[100%] px-3 indicator'>Mega Menu
                <span className="hidden lg:indicator-item badge badge-secondary rounded-none">New</span>
                </div>
            ...
            <div className='flex item-center  justify-between h-[100%] '>
                ...
                <div className='flex items-center h-[100%] hover:bg-yellow-500 px-3 ml-10 bg-yellow-500 text-black'>
