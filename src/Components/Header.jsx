  ...
  return (
    <div className="w-full bg-slate-200 py-2">
      <div className="flex items-center  h-[60px] justify-between   max-w-[1600px]  mx-auto    px-3 md:px-5 lg:px-7 2xl:p-10 ">
        <div className="w-auto font-extrabold text-[30px] sm:text-[34px] md:text-[45px]  font-mono   uppercase">
          Journal
        </div>
        ...
        {isMenuOpen && (
          <div className="absolute top-[60px] left-0 w-[100%] bg-base-200 z-10 flex flex-col items-center p-4 lg:hidden">
            <ul className="w-[60%]">
              ...
              <button className="text-white text-[25px] w-full text-center   hover:text-[27px] hover:box-border" onClick={() => setIsMenuOpen((prev) => !prev)}>
             <IoMdClose/>
              </button>
            </ul>
          </div>
