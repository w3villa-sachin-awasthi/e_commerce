  ...
  return (
    <div className="max-w-[1600px] mx-auto px-3 md:px-5 lg:px-7 2xl:px-10 lg:h-[400px] mb-2 sm:mb-0 sm:my-7 flex lg:flex-row flex-col  ">
      {/* Main child  */}
         <MainHeroSec/>
      {/* first Child  */}
      <div className="w-full lg:w-[450px]   justify-between  sm:mx-2 h-[130px] sm:h-[180px] md:h-[230px]    lg:h-full flex lg:flex-col ">
        ...
        {/* second box */}
        <div className="w-[50%] lg:w-full lg:h-[50%]  flex p-2 bg-slate-200 my-1 mx-1 rounded-xl hover:shadow-[0px_0px_3px_0px_grey]">
            <div className="h-full w-[40%] flex flex-col items-start justify-center sm:px-2 text-[11px] sm:text-[14px] md:text-[17px] leading-2 sm:leading-6">
