...
function HeroSection2() {
  return (
    <div className="max-w-[1600px] mx-auto px-3 md:px-5 lg:px-7 2xl:px-10 lg:h-[400px] my-3 flex lg:flex-row flex-col">
      {/* Main child  */}
         <MainHeroSec/>
      {/* second Child  */}
      <div className="w-full lg:w-[450px]   justify-between  sm:mx-2 h-[150px] sm:h-[210px] md:h-[230px]   lg:h-full flex lg:flex-col ">
        <div className="w-[50%] lg:w-full lg:h-[50%]  flex p-2 bg-slate-200 my-1 rounded-lg mr-1">
        ...
        {/* second box */}
        <div className="w-[50%] lg:w-full lg:h-[50%]  flex p-2 bg-slate-200 my-1 mx-1 rounded-xl">
            <div className="h-full w-[40%] flex flex-col items-start justify-center sm:px-2 text-[11px] sm:text-[14px] md:text-[17px] leading-2 sm:leading-6">
